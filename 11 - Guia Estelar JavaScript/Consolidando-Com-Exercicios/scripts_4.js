...
const booksByCategory = [
    ...
    {
        category: "Intetligência Emocional",
        books: [
            {
...
console.log(`Livros do autor Augusto Cury: ${booksOfAuthor("Augusto Cury").join(", ")}`);
console.log(`Livros do autor T. Harv Eker: ${booksOfAuthor("T. Harv Eker").join(", ")}`);